//
// Created by Tsering Lhakhang on 9/09/21.
//
...
public:
    ...
    friend ostream& operator << (ostream& outs, Language lang) {
        ...
        outs << left << setw(31) << lang.getGenus();
        outs << setw(31) << lang.getFamily();
        outs << setw(17) << lang.getMacroarea();
        outs << setw(13) << lang.getLatitude();
        outs << lang.getLongitude();
        return outs;
    }
    /**Overloaded operator == works for integers. Won't work with Language objects
     *
     * @param lhs
     * @param rhs
